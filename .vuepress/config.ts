...
const author = "程序员TOM GU";
const domain = "129.227.143.65";
const tags = ["程序员", "编程", "计算机","随笔"];
...
export default defineConfig({
  ...
  head: [
    ...
    [
      "meta",
      {
        name: "keywords",
        content:
          "程序员Tom GU, 编程学习路线, 编程知识百科, Java, 编程导航, 前端, 开发, 编程分享, 项目, IT, 求职, 面经，随笔",
      },
    ],
    // 百度统计
    [
  ...
  plugins: [
    ...
    [
      ...
      {
        ga: "G-X6PPEHPBDX", // 补充自己的谷歌分析 ID，比如 UA-00000000-0
      },
    ],
